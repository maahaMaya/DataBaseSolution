...
CREATE TABLE BankTotalAmount 
( 
	id INT PRIMARY KEY  NOT NULL, 
	total_amount BIGINT
)
SELECT * FROM dbo.BankTotalAmount
...
( 
	atm INT PRIMARY KEY IDENTITY(300, 1) NOT NULL,
	branch_id INT FOREIGN KEY(branch_id) REFERENCES BankBranch(branch_id),
	atm_total_money_deposite BIGINT,
	branch_address VARCHAR(500)
)
SELECT * FROM dbo.BankATM;

INSERT INTO dbo.BankATM(branch_id, atm_total_money_deposite, branch_address) VALUES (1, 20, 'PuneX'), (1,  10, 'PuneY'), (1, 15, 'PuneZ')
